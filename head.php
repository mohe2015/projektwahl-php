...
<html lang="de">
  <head>
    ...
    <link rel="stylesheet" href="/tabler/dist/css/tabler.css" />
  ...
  <body>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul class="navbar-nav mr-auto mb-2 mb-lg-0">
            <li class="nav-item"><a class="nav-link" <?php active_exact($ROOT . "/") ?> href="<?php echo $ROOT ?>/"><i class="fas fa-home"></i><span class="hidden-small"> Startseite</span></a></li>
    <?php
    ...
    if (end($_SESSION['users']) && in_array(end($_SESSION['users'])->type, array("admin", "teacher"))): ?>
            <li class="nav-item"><a class="nav-link" <?php active($ROOT . "/project") ?> href="<?php echo $ROOT ?>/projects"><i class="fas fa-users"></i><span class="hidden-small"> Projekte</span></a></li>
    <?php endif; ?>
    <?php if (end($_SESSION['users']) && in_array(end($_SESSION['users'])->type, array("admin"))): ?>
            <li class="nav-item"><a class="nav-link" <?php active($ROOT . "/teacher") ?> href="<?php echo $ROOT ?>/teachers"><i class="fas fa-chalkboard-teacher"></i><span class="hidden-small"> Lehrer</span></a></li>
    <?php endif; ?>
    <?php if (end($_SESSION['users']) && in_array(end($_SESSION['users'])->type, array("admin", "teacher"))): ?>
            <li class="nav-item"><a class="nav-link" <?php active($ROOT . "/student") ?> href="<?php echo $ROOT ?>/students"><i class="fas fa-user"></i><span class="hidden-small"> Schüler</span></a></li>
    <?php endif; ?>
    <?php if (end($_SESSION['users']) && in_array(end($_SESSION['users'])->type, array("student"))): ?>
            <li class="nav-item"><a class="nav-link" <?php active($ROOT . "/election.php") ?> href="<?php echo $ROOT ?>/election.php"><i class="fas fa-poll"></i><span class="hidden-small"> Wahl</span></a></li>
    <?php endif; ?>
